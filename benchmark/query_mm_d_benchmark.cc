...
BENCHMARK_CAPTURE(PhTree3D, WQ_100, 1.0)
    ->RangeMultiplier(10)
    ->Ranges({{100000, 1000 * 1000}, {TestGenerator::CUBE, TestGenerator::CLUSTER}})
    ->Unit(benchmark::kMillisecond);

// PhTreeMultiMap
BENCHMARK_CAPTURE(PhTreeMultiMap3D, WQ_100, 1.0)
    ->RangeMultiplier(10)
    ->Ranges({{100000, 1000 * 1000}, {TestGenerator::CUBE, TestGenerator::CLUSTER}})
    ->Unit(benchmark::kMillisecond);

// PhTreeMultiMap
BENCHMARK_CAPTURE(PhTreeMultiMapStd3D, WQ_100, 1.0)
    ->RangeMultiplier(10)
    ->Ranges({{100000, 1000 * 1000}, {TestGenerator::CUBE, TestGenerator::CLUSTER}})
    ->Unit(benchmark::kMillisecond);
