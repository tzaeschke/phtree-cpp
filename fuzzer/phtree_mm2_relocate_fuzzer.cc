...
#include "include/phtree/phtree_multimap2.h"

// clang++ -g -std=c++17 -fsanitize=address,fuzzer fuzzer/phtree_mm2_relocate_fuzzer.cc -I. -I./include
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* Data, size_t Size) {
    ...
    if (PRINT) {
        std::cout << "TEST(PhTreeMultimap2Test, FuzzTest1) {" << std::endl;
        ...
        std::cout << "    PhTreeMultiMap2<DIM, Value, ConverterNoOp<DIM, std::int64_t>> tree{};" << std::endl;
    }
